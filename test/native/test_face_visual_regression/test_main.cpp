...
void test_face_visual_regression_freezes_key_gaze_signatures() {
  ...
  assert_signature(compose_signature(center_state), {109, 112, 211, 112, 16, 67, 67, 14, 145, 149});
  assert_signature(compose_signature(left_state), {101, 112, 203, 112, 16, 67, 67, 14, 145, 149});
  assert_signature(compose_signature(right_state), {117, 112, 219, 112, 16, 67, 67, 14, 145, 149});
  assert_signature(compose_signature(up_right_state), {115, 108, 217, 108, 16, 67, 67, 14, 145, 149});
}
...
void test_face_visual_regression_freezes_blink_aperture_signatures() {
  ...
  assert_signature(open_signature, {109, 112, 211, 112, 16, 67, 67, 14, 145, 149});
  assert_signature(closing_signature, {109, 112, 211, 112, 8, 67, 33, 8, 145, 149});
  assert_signature(closed_signature, {109, 112, 211, 112, 2, 67, 2, 5, 145, 149});
}
