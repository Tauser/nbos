...
constexpr FrozenSilhouetteFrame kFrozenFrames[] = {
    {ncos::models::face::FaceShapeProfile::kCompanionBalanced, 145, 149, 20, 102},
    {ncos::models::face::FaceShapeProfile::kHeroicWide, 156, 134, 15, 112},
    {ncos::models::face::FaceShapeProfile::kCuriousTall, 139, 152, 18, 98},
    {ncos::models::face::FaceShapeProfile::kPlayfulRound, 147, 151, 24, 100},
};
